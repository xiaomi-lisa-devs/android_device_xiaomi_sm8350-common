...
PRODUCT_COPY_FILES += \
    $(LOCAL_PATH)/media/yupik/media_codecs_yupik_v1_vendor.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_yupik_v1_vendor.xml \
    ...
    $(LOCAL_PATH)/media/yupik/media_codecs_system_default_yupik.xml:$(TARGET_COPY_OUT_VENDOR)/etc/media_codecs_yupik_v1.xml \
